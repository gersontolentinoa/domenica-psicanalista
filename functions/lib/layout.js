...
export function siteHeader(c = SITE_DEFAULTS, hasBlog = true) {
  return `
<nav class="bnav">
  ...
  <div class="bnav-links">
    ...
    ${hasBlog ? '<a href="/blog" class="active">Blog</a>' : ''}
...
export function layout({ title, description, canonical, ogImage, body, content = SITE_DEFAULTS, extraHead = '', hasBlog = true }) {
  return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8" />
